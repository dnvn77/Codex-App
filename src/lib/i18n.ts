...
export const translations = {
  en: {
    ...
    seedBackupConfirmation: 'I have saved my secret phrase in a safe place.',
    cancelButton: 'Cancel',
  ...
  es: {
    ...
    seedBackupConfirmation: 'He guardado mi frase secreta en un lugar seguro.',
  ...
  zh: {
    ...
    seedBackupConfirmation: '我已将我的秘密短语保存在安全的地方。',
    cancelButton: '取消',
    continueButton: '继续',
  ...
  hi: {
    ...
    seedBackupConfirmation: 'मैंने अपना गुप्त वाक्यांश एक सुरक्षित स्थान पर सहेज लिया है।',
  ...
  fr: {
    ...
    seedBackupConfirmation: 'J\'ai sauvegardé ma phrase secrète dans un endroit sûr.',
  ...
  ar: {
    ...
    seedBackupConfirmation: 'لقد قمت بحفظ عبارتي السرية في مكان آمن.',
    cancelButton: 'إلغاء',
  ...
  bn: {
    ...
    seedBackupConfirmation: 'আমি আমার গোপন বাক্যাংশ একটি নিরাপদ স্থানে সংরক্ষণ করেছি।',
  ...
  ru: {
    ...
    seedBackupConfirmation: 'Я сохранил свою секретную фразу в безопасном месте.',
    cancelButton: 'Отмена',
  ...
  pt: {
    ...
    seedBackupConfirmation: 'Eu guardei minha frase secreta em um lugar seguro.',
    cancelButton: 'Cancelar',
    continueButton: 'Continuar',
  ...
  id: {
    ...
    seedBackupConfirmation: 'Saya telah menyimpan frasa rahasia saya di tempat yang aman.',
    cancelButton: 'Batal',
