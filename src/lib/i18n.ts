...
export const translations = {
  ...
  zh: {
    ...
    insufficientTokenBalanceError: (token: string) => `${token} 余额不足。`,
    insufficientGasError: 'ETH 余额不足以支付 gas 费用。',
  ...
  hi: {
    ...
    insufficientTokenBalanceError: (token: string) => `अपर्याप्त ${token} शेष राशि।`,
    insufficientGasError: 'गैस शुल्क के लिए अपर्याप्त ETH शेष राशि।',
  ...
  fr: {
    ...
    insufficientTokenBalanceError: (token: string) => `Solde de ${token} insuffisant.`,
    insufficientGasError: 'Solde ETH insuffisant pour les frais de gaz.',
  ...
  ar: {
    ...
    insufficientTokenBalanceError: (token: string) => `رصيد ${token} غير كافٍ.`,
    insufficientGasError: 'رصيد ETH غير كافٍ لرسوم الغاز.',
  ...
  bn: {
    ...
    insufficientTokenBalanceError: (token: string) => `${token} ব্যালেন্স অপর্যাপ্ত।`,
    insufficientGasError: 'গ্যাস ফির জন্য অপর্যাপ্ত ETH ব্যালেন্স।',
  ...
  ru: {
    ...
    insufficientTokenBalanceError: (token: string) => `Недостаточно средств на балансе ${token}.`,
    insufficientGasError: 'Недостаточно средств ETH для оплаты комиссий за газ.',
  ...
  pt: {
    ...
    insufficientTokenBalanceError: (token: string) => `Saldo de ${token} insuficiente.`,
    insufficientGasError: 'Saldo de ETH insuficiente para taxas de gás.',
  ...
  id: {
    ...
    insufficientTokenBalanceError: (token: string) => `Saldo ${token} tidak mencukupi.`,
    insufficientGasError: 'Saldo ETH tidak mencukupi untuk biaya gas.',
